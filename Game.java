...
public class Game
{
    ...
    /** 
     * @return Return the image of the current Room
     */
    ...
    /**
     * @return Return the object player.
     */
    ...
    /**
     * @return Return the enemy in the player's room.
     */
    ...
    /**
     * @return Return the list containing all the enemies.
     */
